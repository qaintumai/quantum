...
class HybridModel(nn.Module):
    def __init__(self, num_layers, num_wires, qnn_circuit):
        super(HybridModel, self).__init__()

        # Initialize the quantum neural network layer
        self.quantum_nn = QuantumNeuralNetwork(num_layers, num_wires, qnn_circuit).qlayers
...
qnn_model = HybridModel(num_layers, num_wires, qnn_circuit)
